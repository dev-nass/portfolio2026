...
<template>
  <section id="hero" class="mx-auto max-w-5xl px-4 py-12 md:py-20 lg:py-28">
    <div class="flex flex-col items-center gap-8 md:flex-row md:items-stretch md:gap-8 lg:gap-12">
      ...
      <div class="hidden w-[30%] flex-shrink-0 md:block">
        ...
        >
          <img
            ...
            :style="{ filter: 'sepia(1) hue-rotate(80deg) saturate(3) brightness(0.8)' }"
          />
          <div class="pointer-events-none absolute inset-0 rounded border border-green/10" />
        </div>
      </div>
        ...
        <TerminalWindow title="whoami — ~">
          <div class="space-y-4 font-mono text-sm">
            ...
            <div v-if="stage >= 1">
              ...
              <div class="mt-1 whitespace-pre-line pl-2 text-text-muted">
                <TypeWriter
                  :text="about"
                  :speed="20"
                  :delay="500"
            ...
            <!-- Social Links -->
            <div v-if="stage >= 2" class="flex flex-wrap gap-3 pt-2">
              <a
